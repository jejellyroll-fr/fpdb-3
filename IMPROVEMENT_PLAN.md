...
- ✅ **Séparateurs des requêtes extraites** (2026-07-16) : les `/n` résiduels du commentaire de la requête HUD agrégée ont été supprimés et une garde vérifie les catalogues finaux SQLite/PostgreSQL/MySQL contre `/n` et `\\n` littéral.
