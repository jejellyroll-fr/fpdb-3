...
- 🟡 **God-module `Database.py`** (2026-07-13) : première tranche sur l'interface multi-backend de connexion/cursor, les caches d'identifiants et les buffers d'import. Le chargement optionnel de NumPy ne bloque plus mypy Python 3.11 et la dette locale est passée de 132 à 40 diagnostics ; le module rejoindra le ratchet après traitement des assemblages HUD/cache restants.
