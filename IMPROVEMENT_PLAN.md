...
- 🟡 **Typage progressif** (2026-07-13) : mypy activé en CI sur `equity.py`, `dialects.py`, `pt4_adapter/`, le domaine HTTP capture/OFC et les fondations menus/i18n (dix-neuf modules), avec imports externes ignorés et corps non annotés vérifiés. Le périmètre sera élargi par domaine sans imposer immédiatement le typage aux god-modules.
