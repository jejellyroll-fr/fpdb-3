...
- ✅ **Dette source traçable** (2026-07-16) : les 73 `TODO/FIXME/HACK` initiaux sont inventoriés dans `TECHNICAL_DEBT.md`, avec identifiants stables, catégories et liens source ; la CI interdit que le registre diverge du code. Première dette résolue : la sélection CLI distingue désormais l'absence de `--databaseName` d'un nom explicitement vide, ramenant le registre à 72 entrées.
