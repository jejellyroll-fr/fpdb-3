...
class TestCalcCBets:
    ...
    def test_preflop_aggressor_identification(self):
        ...
        hand = self.create_mock_hand(
            action_streets=["BLINDSANTES", "PREFLOP", "FLOP"], actions={"PREFLOP": preflop_actions, "FLOP": []}
        )
    ...
    def test_cbet_done_when_betting(self):
        ...
        hand = self.create_mock_hand(actions={"PREFLOP": preflop_actions, "FLOP": flop_actions})
    ...
    def test_complex_multiway_action(self):
        ...
        self.derived_stats.handsplayers = {"aggressor": {}, "caller": {}, "folder": {}, "raiser": {}}
