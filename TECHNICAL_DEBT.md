...
| `TD-1C729FFE` | parser | TODO | [fpdb_3_legacy/WinamaxToFpdb.py:520](fpdb_3_legacy/WinamaxToFpdb.py#L520) | maintainer): long-term solution for table naming on Winamax. |
| `TD-AADEA234` | parser | TODO | [fpdb_3_legacy/WinamaxToFpdb.py:607](fpdb_3_legacy/WinamaxToFpdb.py#L607) | maintainer): Is this correct? Old code tried to |
