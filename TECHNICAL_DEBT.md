...
|---|---|---|---|---|
| `TD-C4001A69` | parser | TODO | [fpdb_3_legacy/AbsoluteToFpdb.py:150](fpdb_3_legacy/AbsoluteToFpdb.py#L150) | Absolute posting when coming in new: %s - Posts $0.02 .. should that be a new Post line? where do we need to add support for that? *confused* |
| `TD-E7B1E72B` | parser | TODO | [fpdb_3_legacy/AbsoluteToFpdb.py:259](fpdb_3_legacy/AbsoluteToFpdb.py#L259) | AP does provide Small BET for Limit .. I think? at least 1-on-1 limit they do.. sigh |
| `TD-CAD4A4C1` | parser | TODO | [fpdb_3_legacy/AbsoluteToFpdb.py:305](fpdb_3_legacy/AbsoluteToFpdb.py#L305) | 1-on-1) does have that info in the game type line |
| `TD-6DEBDDEA` | parser | TODO | [fpdb_3_legacy/AbsoluteToFpdb.py:319](fpdb_3_legacy/AbsoluteToFpdb.py#L319) | implement lookup list by table-name to determine maxes, |
| `TD-EB5B8ECA` | parser | TODO | [fpdb_3_legacy/AbsoluteToFpdb.py:336](fpdb_3_legacy/AbsoluteToFpdb.py#L336) | Not implemented yet |
| `TD-9EF696E5` | parser | TODO | [fpdb_3_legacy/AbsoluteToFpdb.py:482](fpdb_3_legacy/AbsoluteToFpdb.py#L482) | not supported yet ? |
