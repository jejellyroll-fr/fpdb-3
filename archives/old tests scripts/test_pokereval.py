...
if pokereval.best_hand_value("hi", ["Ah", "Ad", "As", "Kh", "Ks"]) != 101494784:
    print(pokereval.best_hand_value("hi", ["Ah", "Ad", "As", "Kh", "Ks"]))
    sys.exit(1)

if pokereval.string2card("2h") != 0:
    print(pokereval.string2card("2h"))
    sys.exit(1)
...
print(
    ("4/ low hand from %s / %s = %s")
    % (hand, board, pokereval.best("low", hand, board))
)
print(
...
best_hand = pokereval.best_hand("low", hand, board)
print(
    ("low hand from %s / %s = %s") % (hand, board, pokereval.best("low", hand, board))
)
print(
    ("best low hand from %s / %s = (%s) %s ")
    % (hand, board, best_hand[0], [pokereval.card2string(i) for i in best_hand[1:]])
