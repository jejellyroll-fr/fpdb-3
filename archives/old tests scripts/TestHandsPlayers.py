...
def main(argv=None):
    ...
    if sites["PacificPoker"] == True and not single_file_test:
        walk_testfiles(
            "regression-test-files/cash/PacificPoker/",
            compare,
            importer,
            PacificPokerErrors,
            "PacificPoker",
        ...
        walk_testfiles(
            "regression-test-files/tour/PacificPoker/",
            compare,
            importer,
            PacificPokerErrors,
            "PacificPoker",
        ...
        walk_testfiles(
            "regression-test-files/summaries/PacificPoker/",
            compare,
            importer,
            PacificPokerErrors,
            "PacificPoker",
        ...
        walk_testfiles(
            options.filename, compare, importer, PacificPokerErrors, "PacificPoker"
        )
