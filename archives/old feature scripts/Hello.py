...
from Aux_Base import Aux_Seats, Aux_Window, Seat_Window
...
class Hello_plus(Aux_Window):
    ...
    def update_gui(self, new_hand_id):
        ...
        self.label.set_text(
            ...
            % (self.hero, self.hands_played, self.site)
        )
...
class Hello_Seats(Aux_Seats):
    ...
    def update_contents(self, container, i):
        ...
        if id == None:
            ...
            container.label.set_text(
                "player = %s" % self.hud.stat_dict[id]["screen_name"]
            )
