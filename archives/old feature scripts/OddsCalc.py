...
class OddsCalc:
    def __init__(
        self, game, dead, board, hero, vilain1, vilain2, vilain3, vilain4, vilain5
    ) -> None:
    ...
    def calcBaseHoldem(self):
        ...
        h, [_, *d] = [i.text for i in s.tr.find_all("th")], [
            [i.text for i in b.find_all("td")] for b in s.find_all("tr")
        ]
