"""Starting-card statistics cache schema queries."""

from __future__ import annotations


def cards_cache_schema_queries(db_server: str) -> dict[str, str]:
    """Return backend-specific DDL for CardsCache."""
    if db_server == "mysql":
        ddl = """CREATE TABLE CardsCache (
        ...
        return {}
    return {"createCardsCacheTable": ddl}
