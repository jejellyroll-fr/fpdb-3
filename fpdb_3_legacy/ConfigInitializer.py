...
class ConfigInitializer:
    ...
    def initialize(cls, config_file: str = "HUD_config.xml", *, fallback_to_default: bool = True) -> Any:
        ...
        try:
            ...
            config_path_result = Configuration.get_config(config_file, fallback_to_default)
        ...
        except Exception:  # intentional broad catch: config init boundary, re-raises unless fallback_to_default
