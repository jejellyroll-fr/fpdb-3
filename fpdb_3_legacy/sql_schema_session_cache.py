"""Session-level statistics cache schema queries."""

from __future__ import annotations


def session_cache_schema_queries(db_server: str) -> dict[str, str]:
    """Return backend-specific DDL for SessionsCache."""
    if db_server == "mysql":
        ddl = """CREATE TABLE SessionsCache (
        ...
        return {}
    return {"createSessionsCacheTable": ddl}
