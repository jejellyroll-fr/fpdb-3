    ...
    if db_server == "mysql":
        query["get_stats_from_hand_session"] = """
                SELECT hp.playerId                                              AS player_id, /* playerId and seats must */
                       ...
                       /* PT4 action-enum counters. The session read aggregates
                          HandsPlayers rows in Python, so they are counted per hand
                          here rather than summed out of HudCache. */
                       CASE WHEN hp2.enum_p_3bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_p_face_3bet,
                       CASE WHEN hp2.enum_p_3bet_action = 'C' THEN 1 ELSE 0 END AS cnt_p_call_3bet,
                       CASE WHEN hp2.enum_p_3bet_action = 'R' THEN 1 ELSE 0 END AS cnt_p_raise_3bet,
                       CASE WHEN hp2.enum_p_4bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_p_face_4bet,
                       CASE WHEN hp2.enum_p_4bet_action = 'C' THEN 1 ELSE 0 END AS cnt_p_call_4bet,
                       CASE WHEN hp2.enum_p_4bet_action = 'R' THEN 1 ELSE 0 END AS cnt_p_raise_4bet,
                       CASE WHEN hp2.enum_p_squeeze_action <> 'N' THEN 1 ELSE 0 END AS cnt_p_face_squeeze,
                       CASE WHEN hp2.enum_p_squeeze_action = 'C' THEN 1 ELSE 0 END AS cnt_p_call_squeeze,
                       CASE WHEN hp2.enum_p_squeeze_action = 'R' THEN 1 ELSE 0 END AS cnt_p_raise_squeeze,
                       CASE WHEN hp2.enum_f_cbet_action <> 'N' THEN 1 ELSE 0 END AS cnt_f_face_cbet,
                       CASE WHEN hp2.enum_f_cbet_action = 'C' THEN 1 ELSE 0 END AS cnt_f_call_cbet,
                       CASE WHEN hp2.enum_f_cbet_action = 'R' THEN 1 ELSE 0 END AS cnt_f_raise_cbet,
                       CASE WHEN hp2.enum_f_donk_action <> 'N' THEN 1 ELSE 0 END AS cnt_f_face_donk,
                       CASE WHEN hp2.enum_f_donk_action = 'C' THEN 1 ELSE 0 END AS cnt_f_call_donk,
                       CASE WHEN hp2.enum_f_donk_action = 'R' THEN 1 ELSE 0 END AS cnt_f_raise_donk,
                       CASE WHEN hp2.enum_f_3bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_f_face_3bet,
                       CASE WHEN hp2.enum_f_3bet_action = 'C' THEN 1 ELSE 0 END AS cnt_f_call_3bet,
                       CASE WHEN hp2.enum_f_3bet_action = 'R' THEN 1 ELSE 0 END AS cnt_f_raise_3bet,
                       CASE WHEN hp2.enum_f_4bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_f_face_4bet,
                       CASE WHEN hp2.enum_f_4bet_action = 'C' THEN 1 ELSE 0 END AS cnt_f_call_4bet,
                       CASE WHEN hp2.enum_f_4bet_action = 'R' THEN 1 ELSE 0 END AS cnt_f_raise_4bet,
                       CASE WHEN hp2.enum_t_cbet_action <> 'N' THEN 1 ELSE 0 END AS cnt_t_face_cbet,
                       CASE WHEN hp2.enum_t_cbet_action = 'C' THEN 1 ELSE 0 END AS cnt_t_call_cbet,
                       CASE WHEN hp2.enum_t_cbet_action = 'R' THEN 1 ELSE 0 END AS cnt_t_raise_cbet,
                       CASE WHEN hp2.enum_t_donk_action <> 'N' THEN 1 ELSE 0 END AS cnt_t_face_donk,
                       CASE WHEN hp2.enum_t_donk_action = 'C' THEN 1 ELSE 0 END AS cnt_t_call_donk,
                       CASE WHEN hp2.enum_t_donk_action = 'R' THEN 1 ELSE 0 END AS cnt_t_raise_donk,
                       CASE WHEN hp2.enum_t_3bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_t_face_3bet,
                       CASE WHEN hp2.enum_t_3bet_action = 'C' THEN 1 ELSE 0 END AS cnt_t_call_3bet,
                       CASE WHEN hp2.enum_t_3bet_action = 'R' THEN 1 ELSE 0 END AS cnt_t_raise_3bet,
                       CASE WHEN hp2.enum_t_4bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_t_face_4bet,
                       CASE WHEN hp2.enum_t_4bet_action = 'C' THEN 1 ELSE 0 END AS cnt_t_call_4bet,
                       CASE WHEN hp2.enum_t_4bet_action = 'R' THEN 1 ELSE 0 END AS cnt_t_raise_4bet,
                       CASE WHEN hp2.enum_t_float_action <> 'N' THEN 1 ELSE 0 END AS cnt_t_face_float,
                       CASE WHEN hp2.enum_t_float_action = 'C' THEN 1 ELSE 0 END AS cnt_t_call_float,
                       CASE WHEN hp2.enum_t_float_action = 'R' THEN 1 ELSE 0 END AS cnt_t_raise_float,
                       CASE WHEN hp2.enum_r_cbet_action <> 'N' THEN 1 ELSE 0 END AS cnt_r_face_cbet,
                       CASE WHEN hp2.enum_r_cbet_action = 'C' THEN 1 ELSE 0 END AS cnt_r_call_cbet,
                       CASE WHEN hp2.enum_r_cbet_action = 'R' THEN 1 ELSE 0 END AS cnt_r_raise_cbet,
                       CASE WHEN hp2.enum_r_donk_action <> 'N' THEN 1 ELSE 0 END AS cnt_r_face_donk,
                       CASE WHEN hp2.enum_r_donk_action = 'C' THEN 1 ELSE 0 END AS cnt_r_call_donk,
                       CASE WHEN hp2.enum_r_donk_action = 'R' THEN 1 ELSE 0 END AS cnt_r_raise_donk,
                       CASE WHEN hp2.enum_r_3bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_r_face_3bet,
                       CASE WHEN hp2.enum_r_3bet_action = 'C' THEN 1 ELSE 0 END AS cnt_r_call_3bet,
                       CASE WHEN hp2.enum_r_3bet_action = 'R' THEN 1 ELSE 0 END AS cnt_r_raise_3bet,
                       CASE WHEN hp2.enum_r_4bet_action <> 'N' THEN 1 ELSE 0 END AS cnt_r_face_4bet,
                       CASE WHEN hp2.enum_r_4bet_action = 'C' THEN 1 ELSE 0 END AS cnt_r_call_4bet,
                       CASE WHEN hp2.enum_r_4bet_action = 'R' THEN 1 ELSE 0 END AS cnt_r_raise_4bet,
                       CASE WHEN hp2.enum_r_float_action <> 'N' THEN 1 ELSE 0 END AS cnt_r_face_float,
                       CASE WHEN hp2.enum_r_float_action = 'C' THEN 1 ELSE 0 END AS cnt_r_call_float,
                       CASE WHEN hp2.enum_r_float_action = 'R' THEN 1 ELSE 0 END AS cnt_r_raise_float
                FROM
                     Hands h
