...
class AutoImportConfigObserver(ConfigObserver):
    ...
    def __init__(self, auto_import_gui: GuiAutoImport) -> None:
        ...
        self.observed_paths: list[str] = [
            ...
            "supported_sites.*.TS_path",  # Tournament summary paths
    ...
    def on_config_change(self, change: ConfigChange) -> bool:
        ...
        handlers: dict[str, Callable[[ConfigChange], bool]] = {
            ...
            "TS_path": self._apply_path_change,
            "enabled": self._apply_path_change,
    ...
    def _apply_path_change(self, change: ConfigChange) -> bool:
        ...
        try:
            ...
            if hasattr(self.auto_import, "updatePaths"):
                ...
                log.info("Auto-import directories resynchronised after change for %s", site_name)

        except Exception:  # intentional broad catch: importer path callbacks may be plugin/UI specific.
    ...
    def _apply_filter_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: importer filter callback is optional and dynamic.
    ...
    def _apply_cache_option_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: importer cache callback is optional and dynamic.
    ...
    def _apply_action_option_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: importer action callback is optional and dynamic.
    ...
    def _apply_session_option_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: importer session callbacks are optional and dynamic.
