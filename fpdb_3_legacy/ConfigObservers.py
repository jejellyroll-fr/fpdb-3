...
from fpdb_3_legacy.ConfigurationManager import ChangeType, ConfigChange, ConfigObserver
...
class HUDConfigObserver(ConfigObserver):
    ...
    def _update_hud_settings(self, change: ConfigChange) -> bool:  # noqa: ARG002
        ...
        try:
            ...
            if hasattr(self.hud_main, "hud_instances"):
                ...
                return True
        except Exception:  # intentional broad catch: HUD instances are dynamic runtime UI objects.
    ...
    def _update_stat_settings(self, change: ConfigChange) -> bool:
        ...
        try:
            ...
            if len(parts) >= min_parts_for_stat_set:
                ...
                return True
        except Exception:  # intentional broad catch: HUD stat windows are dynamic runtime UI objects.
    ...
    def _update_hero_name(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: HUD hero callbacks are dynamic runtime UI objects.
...
class GuiPrefsObserver(ConfigObserver):
    ...
    def _update_theme(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: theme backend and GUI callback vary by runtime.
    ...
    def _update_gui_settings(self, change: ConfigChange) -> bool:  # noqa: ARG002
        ...
        except Exception:  # intentional broad catch: GUI tabs are dynamic runtime UI objects.
    ...
    def _update_seat_preferences(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: seat preference observers are dynamic runtime UI objects.
...
class BulkImportConfigObserver(ConfigObserver):
    ...
    def on_config_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: bulk-import callbacks are dynamic runtime UI objects.
