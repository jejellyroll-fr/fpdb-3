...
class WinningSummary(TourneySummary):
    ...
    def getSplitRe(self, _head: str) -> re.Pattern[str]:
        ...
        Called by the importer as ``Class.getSplitRe(Class, head)`` (two args),
        the convention every other summary parser uses; a one-arg @staticmethod
