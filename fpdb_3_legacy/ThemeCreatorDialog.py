...
THEME_PREVIEW_ERRORS = (RuntimeError, TypeError, ValueError)
THEME_CREATE_ERRORS = (ImportError, OSError, RuntimeError, TypeError, ValueError)
...
class ThemeCreatorDialog(QDialog):
    ...
    def update_preview(self):
        ...
        try:
            ...
            """)
        except THEME_PREVIEW_ERRORS as e:
    ...
    def create_theme(self):
        ...
        except THEME_CREATE_ERRORS as e:
