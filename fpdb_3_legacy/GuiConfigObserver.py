...
from fpdb_3_legacy.ConfigurationManager import ConfigChange, ConfigObserver
...
class GuiConfigObserver(ConfigObserver):
    ...
    def on_config_change(self, change: ConfigChange) -> bool:  # noqa: PLR0911
        ...
        except Exception:  # intentional broad catch: observer boundary logs callback failures and returns False.
    ...
    def _apply_theme_change(self, change: ConfigChange) -> bool:
        ...
        try:
            if hasattr(self.main_window, "change_theme"):
                ...
                return False
        except Exception:  # intentional broad catch: theme callback belongs to the runtime GUI shell.
    ...
    def _apply_hero_name_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: thread callbacks are dynamic runtime UI objects.
    ...
    def _apply_path_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: path-change observers are dynamic runtime UI objects.
    ...
    def _apply_filter_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: import filter callbacks are dynamic runtime UI objects.
    ...
    def _apply_seat_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: seat preference callbacks are dynamic runtime UI objects.
    ...
    def _apply_gui_setting_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: GUI setting callbacks are dynamic runtime UI objects.
    ...
    def _apply_hud_change(self, change: ConfigChange) -> bool:
        ...
        except Exception:  # intentional broad catch: HUD reload callback belongs to the runtime GUI shell.
