"""Primary PositionsCache write and lookup queries."""

from __future__ import annotations


def positions_cache_write_queries() -> dict[str, str]:
    """Return PositionsCache insert, update, and lookup queries."""
    query: dict[str, str] = {}
    query["insert_positionscache"] = """insert into PositionsCache (
            weekId,
            monthId,
            gametypeId,
            tourneyTypeId,
    ...
    query["select_positionscache_tour"] = """
                SELECT id
                FROM PositionsCache
                WHERE weekId=%s
                AND   monthId=%s
