...
onlinehelp = {
    "Game": "Type de jeu (Hold'em, Omaha, etc.)",
    "Hand": "Cartes de départ (Hole cards)",
    "Posn": "Position à la table",
    "Name": "Nom du joueur",
    "Hds": "Nombre de mains jouées",
    "Seats": "Nombre de sièges à la table",
    "VPIP": "Volontairement mis de l'argent dans le pot préflop",
    "PFR": "Relance préflop",
    "PF3": "% 3-bet préflop",
    "Flop3B": "% 3-bet au flop",
    "Turn3B": "% 3-bet au turn",
    "Rivr3B": "% 3-bet à la river",
    "Flop4B": "% 4-bet au flop",
    "Turn4B": "% 4-bet au turn",
    "Rivr4B": "% 4-bet à la river",
    "FOpen": "% ouverture de mise au flop",
    "TOpen": "% ouverture de mise au turn",
    "ROpen": "% ouverture de mise à la river",
    "PF4": "% 4-bet préflop",
    "PFF3": "% abandon (fold) face à un 3-bet préflop",
    "PFF4": "% abandon (fold) face à un 4-bet préflop",
    "AggFac": "Facteur d'agression post-flop",
    "AggFreq": "Fréquence d'agression post-flop",
    "ContBet": "% Continuation Bet",
    "RFI": "% Relance en étant premier à parler (Raise First In)",
    "RST": "% Re-steal",
    "Steals": "% Tentative de vol de blinds (Steal)",
    "SucSt": "% Succès des tentatives de vol",
    "fSB": "% Abandon de la petite blind face à un vol",
    "fBB": "% Abandon de la grosse blind face à un vol",
    "CARpre": "% Suivi d'une relance préflop (Call Raise)",
    "Saw_F": "% Flops vus",
    "SawSD": "% Showdowns vus",
    "WtSDwsF": "% Allé au showdown après avoir vu le flop",
    "W$wsF": "% Gagné de l'argent après avoir vu le flop",
    "W$SD": "% Gagné de l'argent lors du showdown",
    "FlAFq": "Fréquence d'agression au flop",
    "TuAFq": "Fréquence d'agression au turn",
    "RvAFq": "Fréquence d'agression à la river",
    "Net($)": "Profit net total",
    "bb/100": "Nombre de Big Blinds gagnées par 100 mains",
    "Profit/Hnd": "Profit par main",
    "Rake($)": "Rake payé",
    "bbxr/100": "Big Blinds gagnées par 100 mains sans le rake",
    "ProfitHndXR": "Profit par main sans le rake",
    "Variance": "Mesure d'incertitude",
    "Std. Dev.": "Mesure d'incertitude"
}
