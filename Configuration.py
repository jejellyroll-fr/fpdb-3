...
#                return layout_node
    ...
    def set_db_parameters(self, db_name = 'fpdb', db_ip = None, db_port = None, db_user = None,
    ...
    def add_db_parameters(self, db_name = 'fpdb', db_ip = None, db_port = None, db_user = None,
                          db_pass = None, db_desc = None, db_server = None,
                          default = "False"):
        default = default.lower()
        defaultb = string_to_bool(default, False)
