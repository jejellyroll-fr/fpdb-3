...
class TestAssembleHands:
    ...
    def stats(self):
        ...
        def mock_playersAtStreetX(hand):
    ...
    def test_basic_hand_assembly(self, stats):
    ...
    def test_tournament_hand(self, stats):
    ...
    def test_no_hero_hand(self, stats):
    ...
    def test_incomplete_board(self, stats):
    ...
    def test_run_it_twice(self, stats):
    ...
    def test_split_pot_game(self, stats):
    ...
    def test_empty_actions(self, stats):
    ...
    def test_special_board_cards(self, stats):
    ...
    def test_max_position_initialization(self, stats):
