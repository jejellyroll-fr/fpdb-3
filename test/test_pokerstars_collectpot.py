...
"""
        ...
        collect_match = Mock()
        collect_match.group.side_effect = lambda x: {"SEAT": "1", "PNAME": "Hero", "POT": "1.05"}.get(x)
...
"""
        ...
        pre_collect_match.group.side_effect = lambda x: {"PNAME": "Hero", "POT": "1.05"}.get(x)
...
"""
        ...
        fee_collect_match.group.side_effect = lambda x: {"PNAME": "Hero", "POT": "1.00", "FEE": "0.05"}.get(x)
...
"""
        ...
        collect_match1 = Mock()
        collect_match1.group.side_effect = lambda x: {"SEAT": "1", "PNAME": "Hero", "POT": "1.05"}.get(x)

        collect_match2 = Mock()
        collect_match2.group.side_effect = lambda x: {"SEAT": "2", "PNAME": "Villain", "POT": "1.05"}.get(x)
...
"""
        ...
        fee_collect_match = Mock()
        fee_collect_match.group.side_effect = lambda x: {"PNAME": "Hero", "POT": "1,234.56", "FEE": "12.34"}.get(x)
