...
class TestHUDTooltips:
    ...
    def test_tooltip_displays_dash_fraction_for_no_data(self, qapp, mock_aw) -> None:
    ...
    def test_tooltip_displays_zero_fraction_for_tight_player(self, qapp, mock_aw) -> None:
    ...
    def test_tooltip_displays_normal_fraction_for_regular_player(self, qapp, mock_aw) -> None:
        """Test tooltip displays (n/m) fraction for regular player."""
        stat_dict = {1: {"screen_name": "RegularPlayer", "vpip": 10, "vpip_opp": 50}}
    ...
    def test_tooltip_consistency_across_stats(self, qapp, mock_aw) -> None:
    ...
    def test_classic_stat_enhanced_tooltip(self, qapp, mock_aw) -> None:
    ...
    def test_tooltip_updates_correctly_on_data_change(self, qapp, mock_aw) -> None:
        ...
        # Start with no data
        stat_dict_no_data = {1: {"screen_name": "Player", "vpip": 0, "vpip_opp": 0}}

        # Change to tight player
        stat_dict_tight = {1: {"screen_name": "Player", "vpip": 0, "vpip_opp": 20}}

        # Change to regular player
        stat_dict_regular = {1: {"screen_name": "Player", "vpip": 10, "vpip_opp": 50}}
...
class TestHUDPopups:
    ...
    def mock_config(self):
        ...
        config.get_site_parameters = Mock(
            return_value={"popup_fgcolor": "#000000", "popup_bgcolor": "#FFFFFF", "font": "Arial", "font_size": 10},
        )
        return config
    ...
    def test_popup_multicol_with_no_data(self, qapp, mock_window) -> None:
...
class TestHUDPopupInteraction:
    ...
    def test_stat_click_shows_popup_with_no_data(self, qapp, mock_aw) -> None:
    ...
    def test_popup_content_consistency_with_main_display(self, qapp, mock_aw) -> None:
...
class TestHUDStatFormatting:
    ...
    def test_stat_formatting_no_data_consistent(self, qapp, mock_aw) -> None:
    ...
    def test_stat_formatting_zero_consistent(self, qapp, mock_aw) -> None:
    ...
    def test_stat_formatting_percentage_consistent(self, qapp, mock_aw) -> None:
