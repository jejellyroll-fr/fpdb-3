...
class TestFoldFrequencyNoDataFeature:
    ...
    def test_ffreq1_with_no_opportunities(self) -> None:
        """Test ffreq1 returns '-' when no raise opportunities available."""
        stat_dict = {"player1": {"f_freq_1": 0, "was_raised_1": 0}}
    ...
    def test_ffreq1_with_zero_but_opportunities(self) -> None:
        """Test ffreq1 returns '0.0' when player never folds but faced raises."""
        stat_dict = {"player1": {"f_freq_1": 0, "was_raised_1": 10}}
        result = ffreq1(stat_dict, "player1")
    ...
    def test_ffreq1_with_normal_value(self) -> None:
        """Test ffreq1 returns normal percentage when player has stats."""
        stat_dict = {"player1": {"f_freq_1": 3, "was_raised_1": 10}}
        result = ffreq1(stat_dict, "player1")
    ...
    def test_ffreq2_with_no_opportunities(self) -> None:
        """Test ffreq2 returns '-' when no raise opportunities available."""
        stat_dict = {"player1": {"f_freq_2": 0, "was_raised_2": 0}}
    ...
    def test_ffreq3_with_no_opportunities(self) -> None:
        """Test ffreq3 returns '-' when no raise opportunities available."""
        stat_dict = {"player1": {"f_freq_3": 0, "was_raised_3": 0}}
    ...
    def test_ffreq4_with_no_opportunities(self) -> None:
        """Test ffreq4 returns '-' when no raise opportunities available."""
        stat_dict = {"player1": {"f_freq_4": 0, "was_raised_4": 0}}
    ...
    def test_all_streets_fold_frequency_consistency(self) -> None:
        ...
        stat_dict = {
            "player1": {
                ...
                "was_raised_3": 2,
                "f_freq_4": 0,
                "was_raised_4": 0,  # No opportunities
            },
        }
...
class TestFoldToCBetNoDataFeature:
    ...
    def test_f_cb1_with_no_opportunities(self) -> None:
        """Test f_cb1 returns '-' when no cbet opportunities available."""
        stat_dict = {"player1": {"f_cb_1": 0, "f_cb_opp_1": 0}}
    ...
    def test_f_cb1_with_zero_but_opportunities(self) -> None:
        """Test f_cb1 returns '0.0' when player never folds to cbet but faced them."""
        stat_dict = {"player1": {"f_cb_1": 0, "f_cb_opp_1": 8}}
        result = f_cb1(stat_dict, "player1")
    ...
    def test_f_cb1_with_normal_value(self) -> None:
        """Test f_cb1 returns normal percentage when player has stats."""
        stat_dict = {"player1": {"f_cb_1": 4, "f_cb_opp_1": 8}}
        result = f_cb1(stat_dict, "player1")
    ...
    def test_f_cb2_with_no_opportunities(self) -> None:
        """Test f_cb2 returns '-' when no cbet opportunities available."""
        stat_dict = {"player1": {"f_cb_2": 0, "f_cb_opp_2": 0}}
    ...
    def test_f_cb3_with_no_opportunities(self) -> None:
        """Test f_cb3 returns '-' when no cbet opportunities available."""
        stat_dict = {"player1": {"f_cb_3": 0, "f_cb_opp_3": 0}}
    ...
    def test_f_cb4_with_no_opportunities(self) -> None:
        """Test f_cb4 returns '-' when no cbet opportunities available."""
        stat_dict = {"player1": {"f_cb_4": 0, "f_cb_opp_4": 0}}
    ...
    def test_all_streets_fold_cbet_consistency(self) -> None:
        """Test all fold to cbet stats behave consistently."""
        stat_dict = {
            "player1": {
                "f_cb_1": 3,
                "f_cb_opp_1": 6,  # 50% fold to flop cbet
                "f_cb_2": 1,
                "f_cb_opp_2": 4,  # 25% fold to turn cbet
                "f_cb_3": 0,
                "f_cb_opp_3": 2,  # 0% fold to river cbet
                "f_cb_4": 0,
                "f_cb_opp_4": 0,  # No 7th street cbet opportunities
            },
        }
...
class TestCheckRaiseNoDataFeature:
    ...
    def test_cr1_with_no_opportunities(self) -> None:
        """Test cr1 returns '-' when no check-raise opportunities available."""
        stat_dict = {"player1": {"cr_1": 0, "cr_opp_1": 0}}
    ...
    def test_cr1_with_zero_but_opportunities(self) -> None:
        """Test cr1 returns '0.0' when player never check-raises but had opportunities."""
        stat_dict = {"player1": {"cr_1": 0, "ccr_opp_1": 5}}
        result = cr1(stat_dict, "player1")
    ...
    def test_cr1_with_normal_value(self) -> None:
        """Test cr1 returns normal percentage when player has stats."""
        stat_dict = {"player1": {"cr_1": 1, "ccr_opp_1": 5}}
        result = cr1(stat_dict, "player1")
    ...
    def test_cr2_with_no_opportunities(self) -> None:
        """Test cr2 returns '-' when no check-raise opportunities available."""
        stat_dict = {"player1": {"cr_2": 0, "cr_opp_2": 0}}
    ...
    def test_cr3_with_no_opportunities(self) -> None:
        """Test cr3 returns '-' when no check-raise opportunities available."""
        stat_dict = {"player1": {"cr_3": 0, "cr_opp_3": 0}}
    ...
    def test_cr4_with_no_opportunities(self) -> None:
        """Test cr4 returns '-' when no check-raise opportunities available."""
        stat_dict = {"player1": {"cr_4": 0, "cr_opp_4": 0}}
    ...
    def test_all_streets_check_raise_consistency(self) -> None:
        """Test all check-raise stats behave consistently."""
        stat_dict = {
            "player1": {
                "cr_1": 1,
                "ccr_opp_1": 10,  # 10% check-raise flop
                "cr_2": 0,
                "ccr_opp_2": 5,  # 0% check-raise turn
                "cr_3": 0,
                "ccr_opp_3": 2,  # 0% check-raise river
                "cr_4": 0,
                "ccr_opp_4": 0,  # No 7th street check-raise opportunities
            },
        }
...
class TestFoldCheckRaiseIntegration:
    ...
    def test_defensive_aggressive_player_profile(self) -> None:
        """Test a player who is defensive (folds a lot) but aggressive when not folding."""
        stat_dict = {
            "def_agg_player": {
                # Fold frequency - folds often when raised
                "f_freq_1": 7,
                "was_raised_1": 10,  # 70% fold to flop raise
                "f_freq_2": 4,
                "was_raised_2": 5,  # 80% fold to turn raise
                "f_freq_3": 2,
                "was_raised_3": 2,  # 100% fold to river raise
                "f_freq_4": 0,
                "was_raised_4": 0,  # No 7th street raises faced
                # Fold to cbet - also folds often to cbets
                "f_cb_1": 6,
                "f_cb_opp_1": 8,  # 75% fold to flop cbet
                "f_cb_2": 3,
                "f_cb_opp_2": 4,  # 75% fold to turn cbet
                "f_cb_3": 1,
                "f_cb_opp_3": 1,  # 100% fold to river cbet
                "f_cb_4": 0,
                "f_cb_opp_4": 0,  # No 7th street cbets faced
                # Check-raise - when doesn't fold, can be aggressive
                "cr_1": 2,
                "ccr_opp_1": 8,  # 25% check-raise flop
                "cr_2": 1,
                "ccr_opp_2": 3,  # 33% check-raise turn
                "cr_3": 0,
                "ccr_opp_3": 1,  # 0% check-raise river
                "cr_4": 0,
                "ccr_opp_4": 0,  # No 7th street check-raise opps
            },
        }
    ...
    def test_new_player_no_defensive_stats(self) -> None:
    ...
    def test_calling_station_profile(self) -> None:
        ...
        stat_dict = {
            "calling_station": {
                ...
                "f_cb_opp_3": 3,
                "f_cb_4": 0,
                "f_cb_opp_4": 0,  # No 7th street cbets
                # Never check-raises
                "cr_1": 0,
                "ccr_opp_1": 20,
                "cr_2": 0,
...
class TestFoldCheckRaiseRegressionTests:
    ...
    def test_exception_handling_fold_frequency(self) -> None:
    ...
    def test_exception_handling_fold_cbet(self) -> None:
    ...
    def test_exception_handling_check_raise(self) -> None:
    ...
    def test_missing_keys_handling(self) -> None:
