    ...
    def stat_dict_tight_player(self):
        ...
        return {
            1: {
                ...
                'vpip': 0, 'vpip_opp': 20,  # Had opportunities but didn't play
                'pfr': 0, 'pfr_opp': 20,    # Had opportunities but didn't raise
                'tb_0': 0, 'tb_opp_0': 5,   # Had opportunities but didn't 3-bet
                'steal': 0, 'steal_opp': 8, # Had opportunities but didn't steal
                'cb_1': 0, 'cb_2': 0, 'cb_3': 0, 'cb_4': 0,
                'cb_opp_1': 0, 'cb_opp_2': 0, 'cb_opp_3': 0, 'cb_opp_4': 0,
                'aggr_1': 0, 'aggr_2': 0, 'aggr_3': 0, 'aggr_4': 0,
                'call_1': 3, 'call_2': 1, 'call_3': 0, 'call_4': 0,
                'saw_f': 5, 'saw_2': 2, 'saw_3': 1, 'saw_4': 0
            }
        }
...
class TestSimpleStatDisplay:
    ...
    def test_simple_stat_displays_dash_for_no_data(self, qapp, mock_aw):
    ...
    def test_simple_stat_displays_zero_for_tight_player(self, qapp, mock_aw):
    ...
    def test_simple_stat_displays_normal_percentage(self, qapp, mock_aw):
    ...
    def test_simple_stat_multiple_stats_consistency(self, qapp, mock_aw):
    ...
    def test_simple_stat_tooltip_with_no_data(self, qapp, mock_aw):
...
class TestClassicStatDisplay:
    ...
    def test_classic_stat_displays_dash_for_no_data(self, qapp, mock_aw):
    ...
    def test_classic_stat_displays_zero_for_tight_player(self, qapp, mock_aw):
    ...
    def test_classic_stat_color_handling_no_data(self, qapp, mock_aw):
    ...
    def test_classic_stat_tooltip_enhanced_for_no_data(self, qapp, mock_aw):
...
class TestHUDIntegrationScenarios:
    ...
    def test_new_player_all_stats_show_dash(self, qapp, mock_stat_window):
    ...
    def test_tight_player_mixed_display(self, qapp, mock_stat_window):
        """Test tight player scenario - mix of '0.0' and '-' displays."""
        stat_dict = {
            1: {
                'screen_name': 'TightPlayer',
                'vpip': 0, 'vpip_opp': 20,    # 0.0 - had opportunities
                'pfr': 0, 'pfr_opp': 20,      # 0.0 - had opportunities
                'tb_0': 0, 'tb_opp_0': 0,     # '-' - no opportunities
                'steal': 0, 'steal_opp': 8,   # 0.0 - had opportunities
                'aggr_1': 0, 'aggr_2': 0, 'aggr_3': 0, 'aggr_4': 0,
                'call_1': 3, 'call_2': 1, 'call_3': 0, 'call_4': 0,
                'saw_f': 5, 'saw_2': 2, 'saw_3': 0, 'saw_4': 0  # Had some action
            }
        }
    ...
    def test_normal_player_percentage_display(self, qapp, mock_stat_window):
        ...
        stat_dict = {
            1: {
                ...
                'pfr': 5, 'pfr_opp': 50,      # 10%
                'tb_0': 2, 'tb_opp_0': 10,    # 20%
                'steal': 3, 'steal_opp': 12,  # 25%
                'aggr_1': 6, 'aggr_2': 3, 'aggr_3': 1, 'aggr_4': 0,
                'call_1': 4, 'call_2': 2, 'call_3': 1, 'call_4': 0,
                'saw_f': 15, 'saw_2': 8, 'saw_3': 4, 'saw_4': 0
            }
...
class TestHUDUpdatePerformance:
    ...
    def test_stat_update_performance_no_data(self, qapp, mock_aw):
    ...
    def test_stat_update_performance_normal_data(self, qapp, mock_aw):
    ...
    def test_multiple_stats_update_performance(self, qapp, mock_aw):
...
class TestHUDErrorHandling:
    ...
    def test_stat_handles_missing_player(self, qapp, mock_aw):
    ...
    def test_stat_handles_malformed_data(self, qapp, mock_aw):
    ...
    def test_stat_handles_missing_keys(self, qapp, mock_aw):
