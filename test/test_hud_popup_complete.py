...
class MockPopup:
    ...
    def __init__(self, seat, stat_dict, win, pop, hand_instance, config):
        self.seat = seat
...
class TestHUDPopupsComplete:
    ...
    def test_popup_displays_no_data_correctly(self, qapp, mock_aw):
    ...
    def test_popup_displays_mixed_data_correctly(self, qapp, mock_aw):
        ...
        stat_dict = {
            1: {
                ...
                'steal': 3, 'steal_opp': 12,  # Active -> "25.0"
                'cb_1': 0, 'cb_opp_1': 0,     # No data -> "-"
                'aggr_1': 4, 'saw_f': 10      # Active -> "40.0"
            }
        }
    ...
    def test_popup_with_stat_window_integration(self, qapp, mock_aw):
    ...
    def test_popup_tooltip_content_consistency(self, qapp, mock_aw):
    ...
    def test_popup_performance_with_multiple_stats(self, qapp, mock_aw):
    ...
    def test_popup_visual_display(self, qapp, mock_aw):
        ...
        stat_dict = {
            1: {
                ...
                'tb_0': 3, 'tb_opp_0': 12,    # Regular -> "25.0"
                'steal': 2, 'steal_opp': 8,   # Active -> "25.0"
                'cb_1': 0, 'cb_opp_1': 0,     # No data -> "-"
                'aggr_1': 5, 'saw_f': 15      # Active -> "33.3"
            }
        }
    ...
    def test_popup_error_handling(self, qapp, mock_aw):
    ...
    def test_popup_stat_integration_complete(self, qapp, mock_aw):
        """Complete integration test with popup and stat display."""
        # Create comprehensive stat data
        stat_dict = {
            1: {
                'screen_name': 'CompletePlayer',
                'vpip': 12, 'vpip_opp': 60,    # 20% VPIP
                'pfr': 8, 'pfr_opp': 60,       # 13.3% PFR
                'tb_0': 4, 'tb_opp_0': 20,     # 20% 3-bet
                'steal': 5, 'steal_opp': 15,   # 33.3% steal
                'cb_1': 6, 'cb_opp_1': 10,     # 60% c-bet
                'aggr_1': 8, 'saw_f': 25       # 32% aggression frequency
            }
        }
