...
try:
    ...
    if gametype:
        ...
        print(f"Hand processed successfully: {hand.handid}")
        print(f"Total pot: {hand.totalpot}")
        print(f"Rake: {hand.rake}")
        print(f"Total collected: {hand.totalcollected}")
    else:
        print("Failed to determine game type")
