...
class TestColdCallStat:
    ...
    def test_cold_call_with_no_opportunities(self) -> None:
        """Test cold_call returns '-' when no opportunities to cold call."""
        stat_dict = {"player1": {"CAR_opp_0": 0, "CAR_0": 0}}
    ...
    def test_cold_call_with_zero_but_opportunities(self) -> None:
        """Test cold_call returns '0.0' when player never cold called but had opportunities."""
        stat_dict = {"player1": {"CAR_opp_0": 8, "CAR_0": 0}}
        result = cold_call(stat_dict, "player1")
    ...
    def test_cold_call_with_normal_value(self) -> None:
        """Test cold_call returns normal percentage when player cold called."""
        stat_dict = {"player1": {"CAR_opp_0": 10, "CAR_0": 3}}
        result = cold_call(stat_dict, "player1")
    ...
    def test_cold_call_exception_handling(self) -> None:
...
class TestLimpStat:
    ...
    def test_limp_with_no_opportunities(self) -> None:
        """Test limp returns '-' when no preflop opportunities."""
        stat_dict = {"player1": {"vpip_opp": 0, "vpip": 0, "pfr": 0}}
    ...
    def test_limp_with_zero_but_opportunities(self) -> None:
    ...
    def test_limp_with_normal_value(self) -> None:
    ...
    def test_limp_exception_handling(self) -> None:
...
class TestISOStat:
    ...
    def test_iso_with_no_opportunities(self) -> None:
        """Test iso returns '-' when no PFR opportunities."""
        stat_dict = {"player1": {"pfr_opp": 0, "pfr": 0}}
...
class TestRFITotalStat:
    ...
    def test_rfi_total_with_no_opportunities(self) -> None:
        """Test rfi_total returns '-' when no PFR opportunities."""
        stat_dict = {"player1": {"pfr_opp": 0, "pfr": 0, "3bet": 0}}
    ...
    def test_rfi_total_with_zero_but_opportunities(self) -> None:
        """Test rfi_total returns '0.0' when player never raised first in."""
        stat_dict = {"player1": {"pfr_opp": 15, "pfr": 0, "3bet": 0}}
        result = rfi_total(stat_dict, "player1")
    ...
    def test_rfi_total_with_normal_value(self) -> None:
    ...
    def test_rfi_total_exception_handling(self) -> None:
...
class TestThreeBetVsStealStat:
    ...
    def test_three_bet_vs_steal_with_no_opportunities(self) -> None:
        """Test three_bet_vs_steal returns '-' when no 3bet opportunities."""
        stat_dict = {"player1": {"3bet_opp": 0, "3bet": 0}}
...
class TestCallVsStealStat:
    ...
    def test_call_vs_steal_with_no_opportunities(self) -> None:
...
class TestFoldVs4BetStat:
    ...
    def test_fold_vs_4bet_with_no_opportunities(self) -> None:
        """Test fold_vs_4bet returns '-' when no 4bet opportunities."""
        stat_dict = {"player1": {"F4B_opp_0": 0, "F4B_0": 0}}
    ...
    def test_fold_vs_4bet_with_zero_but_opportunities(self) -> None:
        """Test fold_vs_4bet returns '0.0' when player never folded to 4bet."""
        stat_dict = {"player1": {"F4B_opp_0": 5, "F4B_0": 0}}
        result = fold_vs_4bet(stat_dict, "player1")
    ...
    def test_fold_vs_4bet_with_normal_value(self) -> None:
        """Test fold_vs_4bet returns normal percentage when player folded to 4bet."""
        stat_dict = {"player1": {"F4B_opp_0": 6, "F4B_0": 4}}
        result = fold_vs_4bet(stat_dict, "player1")
    ...
    def test_fold_vs_4bet_exception_handling(self) -> None:
    ...
    def test_active_player_with_real_zeros(self) -> None:
        ...
        stat_dict = {
            "active_player": {
                ...
                "CAR_opp_0": 8,
                "CAR_0": 0,  # Never cold called
                "vpip_opp": 25,
                "vpip": 5,
                "pfr": 5,  # Never limped (all VPIP were raises)
                "pfr_opp": 25,
                "3bet": 1,
                "3bet_opp": 10,  # Some 3bets
                "F4B_opp_0": 3,
                "F4B_0": 0,  # Never folded to 4bet
            },
        }
...
class TestNewPreflopStatsRegressionTests:
    ...
    def test_tuple_format_consistency(self) -> None:
        ...
        stats_to_test = [cold_call, limp, iso, rfi_total, three_bet_vs_steal, call_vs_steal, fold_vs_4bet]
