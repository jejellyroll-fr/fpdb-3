...
class TestCBInPositionStat:
    ...
    def test_cb_ip_with_no_opportunities(self) -> None:
        """Test cb_ip returns '-' when no flop or IP opportunities."""
        stat_dict = {"player1": {"cb_opp_1": 0, "cb_1": 0, "street1InPosition": 0, "saw_f": 0}}
    ...
    def test_cb_ip_with_zero_but_opportunities(self) -> None:
        """Test cb_ip returns '0.0' when player had IP opportunities but never c-bet."""
        stat_dict = {"player1": {"cb_opp_1": 10, "cb_1": 0, "street1InPosition": 8, "saw_f": 10}}
        result = cb_ip(stat_dict, "player1")
    ...
    def test_cb_ip_with_normal_value(self) -> None:
        """Test cb_ip returns normal percentage when player c-bet IP."""
        stat_dict = {"player1": {"cb_opp_1": 15, "cb_1": 9, "street1InPosition": 12, "saw_f": 15}}
        result = cb_ip(stat_dict, "player1")
    ...
    def test_cb_ip_exception_handling(self) -> None:
...
class TestCBOutOfPositionStat:
    ...
    def test_cb_oop_with_no_opportunities(self) -> None:
    ...
    def test_cb_oop_with_normal_value(self) -> None:
        """Test cb_oop returns normal percentage when player c-bet OOP."""
        stat_dict = {"player1": {"cb_opp_1": 20, "cb_1": 12, "street1InPosition": 8, "saw_f": 20}}
        result = cb_oop(stat_dict, "player1")
    ...
    def test_cb_oop_exception_handling(self) -> None:
...
class TestTripleBarrelStat:
    ...
    def test_triple_barrel_with_no_opportunities(self) -> None:
        """Test triple_barrel returns '-' when no opportunities on all three streets."""
        stat_dict = {"player1": {"cb_opp_1": 0, "cb_1": 0, "cb_opp_2": 0, "cb_2": 0, "cb_opp_3": 0, "cb_3": 0}}
    ...
    def test_triple_barrel_with_zero_but_opportunities(self) -> None:
        """Test triple_barrel returns '0.0' when player had opportunities but never triple barreled."""
        stat_dict = {"player1": {"cb_opp_1": 10, "cb_1": 0, "cb_opp_2": 8, "cb_2": 0, "cb_opp_3": 6, "cb_3": 0}}
        result = triple_barrel(stat_dict, "player1")
    ...
    def test_triple_barrel_with_normal_value(self) -> None:
        """Test triple_barrel returns normal percentage when player triple barreled."""
        stat_dict = {"player1": {"cb_opp_1": 20, "cb_1": 16, "cb_opp_2": 15, "cb_2": 12, "cb_opp_3": 10, "cb_3": 6}}
        result = triple_barrel(stat_dict, "player1")
    ...
    def test_triple_barrel_exception_handling(self) -> None:
...
class TestRestealStat:
    ...
    def test_resteal_with_no_opportunities(self) -> None:
        """Test resteal returns '-' when no 3-bet opportunities."""
        stat_dict = {"player1": {"tb_opp_0": 0, "tb_0": 0}}
    ...
    def test_resteal_with_zero_but_opportunities(self) -> None:
        """Test resteal returns '0.0' when player had opportunities but never restealed."""
        stat_dict = {"player1": {"tb_opp_0": 15, "tb_0": 0}}
        result = resteal(stat_dict, "player1")
    ...
    def test_resteal_with_normal_value(self) -> None:
        """Test resteal returns normal percentage when player restealed."""
        stat_dict = {"player1": {"tb_opp_0": 20, "tb_0": 4}}
        result = resteal(stat_dict, "player1")
    ...
    def test_resteal_exception_handling(self) -> None:
...
class TestProbeBetTurnStat:
    ...
    def test_probe_bet_turn_with_no_opportunities(self) -> None:
        """Test probe_bet_turn returns '-' when no turn opportunities."""
        stat_dict = {"player1": {"street2Bets": 0, "saw_t": 0, "cb_opp_2": 0, "cb_2": 0}}
    ...
    def test_probe_bet_turn_with_zero_but_opportunities(self) -> None:
        """Test probe_bet_turn returns '0.0' when player had opportunities but never probed turn."""
        stat_dict = {"player1": {"street2Bets": 0, "saw_t": 12, "cb_opp_2": 10, "cb_2": 3}}
        result = probe_bet_turn(stat_dict, "player1")
    ...
    def test_probe_bet_turn_with_normal_value(self) -> None:
        """Test probe_bet_turn returns normal percentage when player probed turn."""
        stat_dict = {"player1": {"street2Bets": 3, "saw_t": 15, "cb_opp_2": 12, "cb_2": 5}}
        result = probe_bet_turn(stat_dict, "player1")
    ...
    def test_probe_bet_turn_exception_handling(self) -> None:
...
class TestProbeBetRiverStat:
    ...
    def test_probe_bet_river_with_no_opportunities(self) -> None:
        """Test probe_bet_river returns '-' when no river opportunities."""
        stat_dict = {"player1": {"street3Bets": 0, "saw_r": 0, "cb_opp_3": 0, "cb_3": 0}}
    ...
    def test_probe_bet_river_with_normal_value(self) -> None:
        """Test probe_bet_river returns normal percentage when player probed river."""
        stat_dict = {"player1": {"street3Bets": 2, "saw_r": 10, "cb_opp_3": 8, "cb_3": 2}}
        result = probe_bet_river(stat_dict, "player1")
    ...
    def test_probe_bet_river_exception_handling(self) -> None:
...
class TestAdvancedStatsIntegration:
    ...
    def test_conservative_player_profile(self) -> None:
...
class TestAdvancedStatsRegressionTests:
    ...
    def test_all_new_stats_exception_handling(self) -> None:
    ...
    def test_tuple_format_consistency(self) -> None:
        ...
        stats_to_test = [cb_ip, cb_oop, triple_barrel, resteal, probe_bet_turn, probe_bet_river]
