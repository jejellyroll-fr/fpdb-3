...
def test_idle_create(import_path, hud_main):
    ...
    with patch(import_path) as mock_qlabel, \
         patch('HUD_main.log') as mock_log:
        ...
        with patch.object(hud_main, 'get_cards', return_value=cards), \
...
def test_zmqreceiver_close(hud_main):
    ...
    with patch.object(zmq_receiver.socket, 'close') as mock_socket_close, \
