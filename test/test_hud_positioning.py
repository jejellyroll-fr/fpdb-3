...
class TestHudPositioning(unittest.TestCase):
    ...
    def test_default_table_coordinates_are_zero(self):
        ...
        self.assertEqual(table_x, 0)
        self.assertEqual(table_y, 0)

    def test_position_calculation_with_valid_table_coords(self):
        ...
        self.assertEqual(final_x, 150)  # 100 + 50
        self.assertEqual(final_y, 225)  # 150 + 75

    def test_position_calculation_with_null_table_coords(self):
        ...
        self.assertEqual(final_x, 100)  # 100 + 0
        self.assertEqual(final_y, 150)  # 150 + 0
    ...
    def test_relative_position_update(self):
        ...
        self.assertEqual(relative_x, 150)  # 200 - 50
        self.assertEqual(relative_y, 175)  # 250 - 75

    def test_layout_deepcopy_preserves_positions(self):
        ...
        self.assertEqual(copied_layout.location[1], (100, 150))
        self.assertEqual(copied_layout.location[2], (200, 100))
        self.assertEqual(copied_layout.common, (400, 300))
        
        # But they should be independent objects
        copied_layout.location[1] = (999, 999)
        self.assertEqual(original_layout.location[1], (100, 150))  # Original unchanged
...
class TestHudLayoutSaving(unittest.TestCase):
    ...
    def test_save_layout_calls_config_correctly(self):
        ...
        expected_new_locs = {1: (120, 170), 2: (220, 120), 3: (320, 170), 
                           4: (320, 370), 5: (220, 420), 6: (120, 370)}
        
        self.config.save_layout_set.assert_called_once_with(
            self.layout_set, 6, expected_new_locs, 800, 600
        )

    def test_position_dict_excludes_common(self):
        ...
        new_locs = {adj[int(i)]: ((pos[0]), (pos[1])) 
                   for i, pos in positions_with_common.items() if i != "common"}
        
        # Common should not be in the dict
        self.assertNotIn("common", new_locs)
        self.assertEqual(len(new_locs), 6)  # Only seat positions
...
class TestHudStatSetSwitching(unittest.TestCase):
    ...
    def test_change_stat_set_restarts_on_refresh_failure(self):
    ...
    def test_refresh_stats_layout_updates_arrays(self):
        ...
        self.assertEqual(simple_hud.nrows, 3)
        self.assertEqual(simple_hud.ncols, 2)
        self.assertEqual(simple_hud.xpad, 5)
        self.assertEqual(simple_hud.ypad, 5)
        
        # Check stats arrays
        self.assertEqual(simple_hud.stats[0][0], "vpip")
        self.assertEqual(simple_hud.stats[0][1], "pfr")
        self.assertEqual(simple_hud.popups[0][0], "popup1")
        self.assertEqual(simple_hud.popups[0][1], "popup2")


class TestHudRegressionPrevention(unittest.TestCase):
    """Test to prevent regression of HUD restart issues."""

    def test_change_stat_set_does_not_always_restart(self):
    ...
    def test_default_coordinates_regression(self):
    ...
    def test_layout_position_persistence(self):
