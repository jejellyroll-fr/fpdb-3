...
class TestHudRestartRegression(unittest.TestCase):
    ...
    def test_stat_set_change_does_not_always_restart(self):
    ...
    def test_refresh_failure_still_allows_restart(self):
...
class TestPositioningRegression(unittest.TestCase):
    ...
    def test_default_table_coordinates_are_zero_not_fifty(self):
        ...
        self.assertEqual(corrected_x, 0)
        self.assertEqual(corrected_y, 0)
        ...
        self.assertNotEqual(corrected_x, old_x)
        self.assertNotEqual(corrected_y, old_y)

    def test_position_calculation_regression(self):
        ...
        self.assertEqual(old_result, (150, 200))
        
        # New way gives (100, 150) - CORRECT
        self.assertEqual(new_result, (100, 150))
        
        # Ensure we're not using the old behavior
        self.assertNotEqual(old_result, new_result)

    def test_position_persistence_across_hands(self):
        ...
        self.assertEqual(new_layout.location[1], (120, 170))
        self.assertEqual(new_layout.location[2], (220, 120))
        
        # Should not revert to default positions
        self.assertNotEqual(new_layout.location[1], (0, 0))
        self.assertNotEqual(new_layout.location[2], (0, 0))


class TestConfigurationReloadRegression(unittest.TestCase):
    """Regression tests for configuration reload issues."""

    def test_layout_sets_cleared_on_reload(self):
        ...
        self.assertEqual(layout.location[1], (100, 150))
        ...
        self.assertIsNotNone(config.layout_sets.get("test_layout"))
        
        # After reload - positions cleared
        simulate_reload()
        self.assertEqual(config.layout_sets, {})
        
        # This is the problematic behavior that requires positions
        # to be saved to XML before any reload occurs

    def test_save_before_reload_workflow(self):
...
class TestMemoryLeakRegression(unittest.TestCase):
    ...
    def test_no_duplicate_hud_instances(self):
        ...
        self.assertEqual(len(active_huds), 1)
        ...
        hud2 = create_hud(table_key)  # This would clean up hud1
    ...
    def test_event_handler_cleanup(self):
        ...
        self.assertEqual(len(event_handlers), 0)


class TestEdgeCaseRegression(unittest.TestCase):
    """Regression tests for edge cases."""

    def test_rapid_stat_set_switching(self):
        ...
        self.assertEqual(config.save.call_count, 3)

    def test_stat_set_switching_with_invalid_config(self):
