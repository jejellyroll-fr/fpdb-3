...
class TestHudStatsPersistence:
    ...
    def test_save_and_load_hud_stats(self, persistence_manager) -> None:
    ...
    def test_stats_expiration(self, persistence_manager) -> None:
    ...
    def test_merge_stats(self, persistence_manager) -> None:
    ...
    def test_cleanup_expired_stats(self, persistence_manager) -> None:
...
class TestImprovedErrorHandler:
    ...
    def test_classify_permanent_error(self, error_handler) -> None:
    ...
    def test_classify_temporary_error(self, error_handler) -> None:
    ...
    def test_classify_recoverable_error(self, error_handler) -> None:
    ...
    def test_should_reset_file_position(self, error_handler) -> None:
...
class TestSmartHudManager:
    ...
    def test_should_restart_for_game_change(self, hud_manager) -> None:
        ...
        assert "holdem" in reason
        assert "omaha" in reason

    def test_should_not_restart_for_minor_seats_change(self, hud_manager) -> None:
    ...
    def test_should_restart_for_major_seats_change(self, hud_manager) -> None:
    ...
    def test_restart_cooldown(self, hud_manager) -> None:
        ...
        should_restart, reason = hud_manager.should_restart_hud(table_key, RestartReason.GAME_TYPE_CHANGE)

        assert should_restart is False
        assert "cooldown" in reason

    def test_table_title_change_detection(self, hud_manager) -> None:
    ...
    def test_error_count_tracking(self, hud_manager) -> None:
        ...
        try:
            ...
            for _i in range(4):
                should_restart, reason = hud_manager.should_restart_hud(table_key, RestartReason.ERROR_RECOVERY)
                assert should_restart is False
    ...
    def test_restart_statistics(self, hud_manager) -> None:
...
class TestIntegration:
    ...
    def test_import_error_to_hud_restart_prevention(self) -> None:
    ...
    def test_stats_persistence_across_restart(self) -> None:
