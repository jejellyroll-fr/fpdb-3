...
class TestContinuationBetNoDataFeature:
    ...
    def test_cb1_with_no_opportunities(self) -> None:
        """Test cb1 returns '-' when no continuation bet opportunities on flop."""
        stat_dict = {"player1": {"cb_opp_1": 0, "cb_1": 0}}
    ...
    def test_cb1_with_zero_but_opportunities(self) -> None:
        """Test cb1 returns '0.0' when player never cbets but had opportunities."""
        stat_dict = {"player1": {"cb_opp_1": 5, "cb_1": 0}}
        result = cb1(stat_dict, "player1")
    ...
    def test_cb1_with_normal_value(self) -> None:
        """Test cb1 returns normal percentage when player cbets."""
        stat_dict = {"player1": {"cb_opp_1": 5, "cb_1": 3}}
        result = cb1(stat_dict, "player1")
    ...
    def test_cb1_exception_handling(self) -> None:
    ...
    def test_cb2_with_no_opportunities(self) -> None:
        """Test cb2 returns '-' when no continuation bet opportunities on turn."""
        stat_dict = {"player1": {"cb_opp_2": 0, "cb_2": 0}}
    ...
    def test_cb2_with_zero_but_opportunities(self) -> None:
        """Test cb2 returns '0.0' when player never cbets but had opportunities."""
        stat_dict = {"player1": {"cb_opp_2": 4, "cb_2": 0}}
        result = cb2(stat_dict, "player1")
    ...
    def test_cb2_with_normal_value(self) -> None:
        """Test cb2 returns normal percentage when player cbets."""
        stat_dict = {"player1": {"cb_opp_2": 4, "cb_2": 2}}
        result = cb2(stat_dict, "player1")
    ...
    def test_cb3_with_no_opportunities(self) -> None:
        """Test cb3 returns '-' when no continuation bet opportunities on river."""
        stat_dict = {"player1": {"cb_opp_3": 0, "cb_3": 0}}
    ...
    def test_cb3_with_zero_but_opportunities(self) -> None:
        """Test cb3 returns '0.0' when player never cbets but had opportunities."""
        stat_dict = {"player1": {"cb_opp_3": 3, "cb_3": 0}}
        result = cb3(stat_dict, "player1")
    ...
    def test_cb3_with_normal_value(self) -> None:
        """Test cb3 returns normal percentage when player cbets."""
        stat_dict = {"player1": {"cb_opp_3": 3, "cb_3": 1}}
        result = cb3(stat_dict, "player1")
    ...
    def test_cb4_with_no_opportunities(self) -> None:
        """Test cb4 returns '-' when no continuation bet opportunities on 7th street."""
        stat_dict = {"player1": {"cb_opp_4": 0, "cb_4": 0}}
    ...
    def test_cb4_with_zero_but_opportunities(self) -> None:
        """Test cb4 returns '0.0' when player never cbets but had opportunities."""
        stat_dict = {"player1": {"cb_opp_4": 2, "cb_4": 0}}
        result = cb4(stat_dict, "player1")
    ...
    def test_cb4_with_normal_value(self) -> None:
        """Test cb4 returns normal percentage when player cbets."""
        stat_dict = {"player1": {"cb_opp_4": 2, "cb_4": 1}}
        result = cb4(stat_dict, "player1")
...
class TestDonkBetNoDataFeature:
    ...
    def test_dbr1_with_no_opportunities(self) -> None:
    ...
    def test_dbr1_with_zero_but_opportunities(self) -> None:
        """Test dbr1 returns '0.0' when player never donks but had opportunities."""
        stat_dict = {
            "player1": {"aggr_1": 2, "cb_1": 2, "saw_f": 8, "cb_opp_1": 3},  # donk_opp = 5, donk_bets = 0
        }
        result = dbr1(stat_dict, "player1")
    ...
    def test_dbr1_with_normal_value(self) -> None:
        """Test dbr1 returns normal percentage when player donks."""
        stat_dict = {
            "player1": {"aggr_1": 5, "cb_1": 2, "saw_f": 10, "cb_opp_1": 2},  # donk_opp = 8, donk_bets = 3
        }
        result = dbr1(stat_dict, "player1")
    ...
    def test_dbr1_exception_handling(self) -> None:
    ...
    def test_dbr2_with_no_opportunities(self) -> None:
    ...
    def test_dbr2_with_zero_but_opportunities(self) -> None:
        """Test dbr2 returns '0.0' when player never donks but had opportunities."""
        stat_dict = {
            "player1": {"aggr_2": 1, "cb_2": 1, "saw_2": 6, "cb_opp_2": 2},  # donk_opp = 4, donk_bets = 0
        }
        result = dbr2(stat_dict, "player1")
    ...
    def test_dbr2_with_normal_value(self) -> None:
        """Test dbr2 returns normal percentage when player donks."""
        stat_dict = {
            "player1": {"aggr_2": 4, "cb_2": 1, "saw_2": 8, "cb_opp_2": 2},  # donk_opp = 6, donk_bets = 3
        }
        result = dbr2(stat_dict, "player1")
    ...
    def test_dbr2_exception_handling(self) -> None:
    ...
    def test_mixed_scenario_cbet_donk_stats(self) -> None:
        ...
        stat_dict = {
            "mixed_player": {
                ...
                "aggr_1": 6,
                "saw_f": 8,  # donk_opp = 2, donk_bets = 2 (aggr_1 - cb_1 = 6-4=2)
...
class TestContinuationDonkRegressionTests:
    ...
    def test_all_cb_functions_exception_handling(self) -> None:
    ...
    def test_all_dbr_functions_exception_handling(self) -> None:
