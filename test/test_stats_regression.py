...
class TestStatsRegression:
    ...
    def test_format_no_data_stat_consistency(self) -> None:
    ...
    def test_zero_vs_no_data_distinction(self) -> None:
        ...
        stat_dict_zero = {"player1": {"vpip": 0, "vpip_opp": 10}}
        result_zero = vpip(stat_dict_zero, "player1")
        assert result_zero[1] == "0.0"

    def test_all_stats_no_data_consistency(self) -> None:
    ...
    def test_exception_handling_preserved(self) -> None:
    ...
    def test_normal_stats_calculation_preserved(self) -> None:
    ...
    def test_fraction_display_consistency(self) -> None:
    ...
    def test_edge_case_zero_opportunities(self) -> None:
        """Test edge cases with zero opportunities."""
        stat_dict_edge = {
            "player1": {
                "vpip": 5,
                "vpip_opp": 0,  # Had actions but no opportunities
                "pfr": 0,
                "pfr_opp": 0,  # No actions, no opportunities
                "tb_0": 10,
                "tb_opp_0": 0,  # Actions but no opportunities (edge case)
            },
        }
    ...
    def test_stats_return_format_consistency(self) -> None:
