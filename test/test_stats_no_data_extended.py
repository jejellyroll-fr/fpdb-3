...
class TestWTSDNoDataFeature:
    ...
    def test_wtsd_with_no_opportunities(self) -> None:
        """Test WTSD returns '-' when no flops seen."""
        stat_dict = {"player1": {"saw_f": 0, "sd": 0}}
    ...
    def test_wtsd_with_zero_but_opportunities(self) -> None:
        """Test WTSD returns '0.0' when player never went to showdown but saw flops."""
        stat_dict = {"player1": {"saw_f": 10, "sd": 0}}
        result = wtsd(stat_dict, "player1")
    ...
    def test_wtsd_with_normal_value(self) -> None:
        """Test WTSD returns normal percentage when player has showdowns."""
        stat_dict = {"player1": {"saw_f": 10, "sd": 3}}
        result = wtsd(stat_dict, "player1")
    ...
    def test_wtsd_exception_handling(self) -> None:
...
class TestWMSDNoDataFeature:
    ...
    def test_wmsd_with_no_showdowns(self) -> None:
        """Test WMSD returns '-' when no showdowns."""
        stat_dict = {"player1": {"sd": 0, "wmsd": 0}}
    ...
    def test_wmsd_with_zero_but_showdowns(self) -> None:
        """Test WMSD returns '0.0' when player never won at showdown but had showdowns."""
        stat_dict = {"player1": {"sd": 5, "wmsd": 0}}
        result = wmsd(stat_dict, "player1")
    ...
    def test_wmsd_with_normal_value(self) -> None:
        """Test WMSD returns normal percentage when player won at showdown."""
        stat_dict = {"player1": {"sd": 5, "wmsd": 3.5}}
        result = wmsd(stat_dict, "player1")
    ...
    def test_wmsd_exception_handling(self) -> None:
...
class TestFourBetNoDataFeature:
    ...
    def test_four_b_with_no_opportunities(self) -> None:
        """Test 4-bet returns '-' when no opportunities."""
        stat_dict = {"player1": {"fb_opp_0": 0, "fb_0": 0}}
    ...
    def test_four_b_with_zero_but_opportunities(self) -> None:
        """Test 4-bet returns '0.0' when player never 4bet but had opportunities."""
        stat_dict = {"player1": {"fb_opp_0": 10, "fb_0": 0}}
        result = four_B(stat_dict, "player1")
    ...
    def test_four_b_with_normal_value(self) -> None:
        """Test 4-bet returns normal percentage when player has 4bets."""
        stat_dict = {"player1": {"fb_opp_0": 10, "fb_0": 2}}
        result = four_B(stat_dict, "player1")
    ...
    def test_four_b_exception_handling(self) -> None:
...
class TestColdFourBetNoDataFeature:
    ...
    def test_cfour_b_with_no_opportunities(self) -> None:
        """Test Cold 4-bet returns '-' when no opportunities."""
        stat_dict = {"player1": {"cfb_opp_0": 0, "cfb_0": 0}}
    ...
    def test_cfour_b_with_zero_but_opportunities(self) -> None:
        """Test Cold 4-bet returns '0.0' when player never cold 4bet but had opportunities."""
        stat_dict = {"player1": {"cfb_opp_0": 8, "cfb_0": 0}}
        result = cfour_B(stat_dict, "player1")
    ...
    def test_cfour_b_with_normal_value(self) -> None:
        """Test Cold 4-bet returns normal percentage when player has cold 4bets."""
        stat_dict = {"player1": {"cfb_opp_0": 8, "cfb_0": 1}}
        result = cfour_B(stat_dict, "player1")
    ...
    def test_cfour_b_exception_handling(self) -> None:
...
class TestFoldSBStealNoDataFeature:
    ...
    def test_f_sb_steal_with_no_opportunities(self) -> None:
        """Test Fold SB to steal returns '-' when no steal attempts."""
        stat_dict = {"player1": {"sbstolen": 0, "sbnotdef": 0}}
    ...
    def test_f_sb_steal_with_zero_but_opportunities(self) -> None:
        """Test Fold SB to steal returns '0.0' when player never folded but had steal attempts."""
        stat_dict = {"player1": {"sbstolen": 5, "sbnotdef": 0}}
        result = f_SB_steal(stat_dict, "player1")
    ...
    def test_f_sb_steal_with_normal_value(self) -> None:
        """Test Fold SB to steal returns normal percentage when player folded."""
        stat_dict = {"player1": {"sbstolen": 5, "sbnotdef": 3}}
        result = f_SB_steal(stat_dict, "player1")
    ...
    def test_f_sb_steal_exception_handling(self) -> None:
...
class TestFoldBBStealNoDataFeature:
    ...
    def test_f_bb_steal_with_no_opportunities(self) -> None:
        """Test Fold BB to steal returns '-' when no steal attempts."""
        stat_dict = {"player1": {"bbstolen": 0, "bbnotdef": 0}}
    ...
    def test_f_bb_steal_with_zero_but_opportunities(self) -> None:
        """Test Fold BB to steal returns '0.0' when player never folded but had steal attempts."""
        stat_dict = {"player1": {"bbstolen": 8, "bbnotdef": 0}}
        result = f_BB_steal(stat_dict, "player1")
    ...
    def test_f_bb_steal_with_normal_value(self) -> None:
        """Test Fold BB to steal returns normal percentage when player folded."""
        stat_dict = {"player1": {"bbstolen": 8, "bbnotdef": 5}}
        result = f_BB_steal(stat_dict, "player1")
    ...
    def test_f_bb_steal_exception_handling(self) -> None:
...
class TestExtendedStatsIntegration:
    ...
    def test_new_player_extended_stats_no_data(self) -> None:
    ...
    def test_active_player_with_real_zeros(self) -> None:
        ...
        stat_dict = {
            "active_player": {
                "saw_f": 20,
                "sd": 0,  # Saw flops but never went to showdown
                "wmsd": 0,  # Never won at showdown
                "fb_opp_0": 10,
                "fb_0": 0,  # Had 4bet opportunities but never 4bet
                "cfb_opp_0": 5,
                "cfb_0": 0,  # Had cold 4bet opportunities but never cold 4bet
                "sbstolen": 8,
                "sbnotdef": 0,  # Had steal attempts but always defended SB
                "bbstolen": 6,
                "bbnotdef": 0,  # Had steal attempts but always defended BB
            },
        }
    ...
    def test_mixed_scenario_extended_stats(self) -> None:
        """Test realistic scenario with some extended stats having data, others not."""
        stat_dict = {
            "mixed_player": {
                "saw_f": 30,
                "sd": 8,  # Went to showdown sometimes
                "wmsd": 5.5,  # Won some at showdown
                "fb_opp_0": 0,
                "fb_0": 0,  # No 4bet opportunities
                "cfb_opp_0": 3,
                "cfb_0": 1,  # Some cold 4bet activity
                "sbstolen": 12,
                "sbnotdef": 7,  # Mixed SB defense
                "bbstolen": 0,
                "bbnotdef": 0,  # No BB steal attempts
            },
        }
