...
class TestFormatNoDataStat:
    ...
    def test_basic_no_data_format(self):
    ...
    def test_no_data_format_with_fraction(self):
    ...
    def test_different_stat_names(self):
...
class TestVPIPNoDataFeature:
    ...
    def test_vpip_with_no_opportunities(self):
    ...
    def test_vpip_with_zero_but_opportunities(self):
    ...
    def test_vpip_with_normal_value(self):
        """Test VPIP returns normal percentage when player has stats."""
        stat_dict = {
            'player1': {'vpip': 5, 'vpip_opp': 10}
        }
        result = vpip(stat_dict, 'player1')
    ...
    def test_vpip_missing_keys(self):
...
class TestPFRNoDataFeature:
    ...
    def test_pfr_with_no_opportunities(self):
        """Test PFR returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'pfr': 0, 'pfr_opp': 0}
        }
    ...
    def test_pfr_with_zero_but_opportunities(self):
        """Test PFR returns '0.0' when player is passive but had opportunities."""
        stat_dict = {
            'player1': {'pfr': 0, 'pfr_opp': 10}
        }
        result = pfr(stat_dict, 'player1')
    ...
    def test_pfr_with_normal_value(self):
        """Test PFR returns normal percentage when player has stats."""
        stat_dict = {
            'player1': {'pfr': 3, 'pfr_opp': 10}
        }
        result = pfr(stat_dict, 'player1')
...
class TestThreeBetNoDataFeature:
    ...
    def test_three_b_with_no_opportunities(self):
        """Test 3-bet returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'tb_0': 0, 'tb_opp_0': 0}
        }
    ...
    def test_three_b_with_zero_but_opportunities(self):
        """Test 3-bet returns '0.0' when player never 3-bets but had opportunities."""
        stat_dict = {
            'player1': {'tb_0': 0, 'tb_opp_0': 10}
        }
        result = three_B(stat_dict, 'player1')
    ...
    def test_three_b_with_normal_value(self):
        """Test 3-bet returns normal percentage when player has stats."""
        stat_dict = {
            'player1': {'tb_0': 2, 'tb_opp_0': 10}
        }
        result = three_B(stat_dict, 'player1')
...
class TestStealNoDataFeature:
    ...
    def test_steal_with_no_opportunities(self):
        """Test steal returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'steal': 0, 'steal_opp': 0}
        }
    ...
    def test_steal_with_zero_but_opportunities(self):
        """Test steal returns '0.0' when player never steals but had opportunities."""
        stat_dict = {
            'player1': {'steal': 0, 'steal_opp': 10}
        }
        result = steal(stat_dict, 'player1')
    ...
    def test_steal_with_normal_value(self):
        """Test steal returns normal percentage when player has stats."""
        stat_dict = {
            'player1': {'steal': 4, 'steal_opp': 10}
        }
        result = steal(stat_dict, 'player1')
...
class TestCBetNoDataFeature:
    ...
    def test_cbet_with_no_opportunities(self):
    ...
    def test_cbet_with_zero_but_opportunities(self):
        """Test cbet returns '0.0' when player never cbets but had opportunities."""
        stat_dict = {
            'player1': {
                'cb_1': 0, 'cb_2': 0, 'cb_3': 0, 'cb_4': 0,
                'cb_opp_1': 5, 'cb_opp_2': 3, 'cb_opp_3': 2, 'cb_opp_4': 0
            }
        }
        result = cbet(stat_dict, 'player1')
    ...
    def test_cbet_with_normal_value(self):
        """Test cbet returns normal percentage when player has stats."""
        stat_dict = {
            'player1': {
                'cb_1': 3, 'cb_2': 2, 'cb_3': 1, 'cb_4': 0,
                'cb_opp_1': 5, 'cb_opp_2': 3, 'cb_opp_3': 2, 'cb_opp_4': 0
            }
        }
        result = cbet(stat_dict, 'player1')
...
class TestAggressionFrequencyNoDataFeature:
    ...
    def test_a_freq1_with_no_opportunities(self):
        """Test a_freq1 returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'aggr_1': 0, 'saw_f': 0}
        }
    ...
    def test_a_freq1_with_zero_but_opportunities(self):
        """Test a_freq1 returns '0.0' when player is passive but saw flops."""
        stat_dict = {
            'player1': {'aggr_1': 0, 'saw_f': 10}
        }
        result = a_freq1(stat_dict, 'player1')
    ...
    def test_a_freq2_with_no_opportunities(self):
        """Test a_freq2 returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'aggr_2': 0, 'saw_2': 0}
        }
    ...
    def test_a_freq3_with_no_opportunities(self):
        """Test a_freq3 returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'aggr_3': 0, 'saw_3': 0}
        }
    ...
    def test_a_freq4_with_no_opportunities(self):
        """Test a_freq4 returns '-' when no opportunities available."""
        stat_dict = {
            'player1': {'aggr_4': 0, 'saw_4': 0}
        }
...
class TestAggressionFactorNoDataFeature:
    ...
    def test_agg_fact_with_no_actions(self):
    ...
    def test_agg_fact_with_only_calls(self):
        """Test agg_fact returns '0.00' when player only calls (passive)."""
        stat_dict = {
            'player1': {
                'aggr_1': 0, 'aggr_2': 0, 'aggr_3': 0, 'aggr_4': 0,
                'call_1': 5, 'call_2': 3, 'call_3': 2, 'call_4': 0
            }
        }
        result = agg_fact(stat_dict, 'player1')
    ...
    def test_agg_fact_pct_with_no_actions(self):
    ...
    def test_agg_fact_pct_with_only_calls(self):
...
class TestRegressionNoDataFeature:
    ...
    def test_vpip_exception_handling(self):
    ...
    def test_pfr_exception_handling(self):
    ...
    def test_three_b_exception_handling(self):
    ...
    def test_steal_exception_handling(self):
    ...
    def test_cbet_exception_handling(self):
...
class TestIntegrationScenarios:
    ...
    def test_tight_passive_player_real_zeros(self):
        """Test stats return '0.0' for a tight passive player with opportunities."""
        stat_dict = {
            'tight_player': {
                'vpip': 0, 'vpip_opp': 20,  # Never played voluntarily
                'pfr': 0, 'pfr_opp': 20,    # Never raised
                'tb_0': 0, 'tb_opp_0': 5,   # Never 3-bet
                'steal': 0, 'steal_opp': 8, # Never stole
                'cb_1': 0, 'cb_2': 0, 'cb_3': 0, 'cb_4': 0,
                'cb_opp_1': 0, 'cb_opp_2': 0, 'cb_opp_3': 0, 'cb_opp_4': 0,  # No c-bet opps
                'aggr_1': 0, 'aggr_2': 0, 'aggr_3': 0, 'aggr_4': 0,
                'call_1': 2, 'call_2': 1, 'call_3': 0, 'call_4': 0,  # Only called
                'saw_f': 5, 'saw_2': 2, 'saw_3': 1, 'saw_4': 0  # Saw some streets
            }
        }
    ...
    def test_mixed_scenario_some_data_some_not(self):
        """Test realistic scenario with some stats having data, others not."""
        stat_dict = {
            'mixed_player': {
                'vpip': 10, 'vpip_opp': 50,    # 20% VPIP (has data)
                'pfr': 5, 'pfr_opp': 50,       # 10% PFR (has data)
                'tb_0': 0, 'tb_opp_0': 0,      # No 3-bet opportunities
                'steal': 2, 'steal_opp': 8,    # 25% steal (has data)
                'cb_1': 0, 'cb_2': 0, 'cb_3': 0, 'cb_4': 0,
                'cb_opp_1': 0, 'cb_opp_2': 0, 'cb_opp_3': 0, 'cb_opp_4': 0,  # No c-bet opps
                'aggr_1': 3, 'aggr_2': 1, 'aggr_3': 0, 'aggr_4': 0,
                'call_1': 2, 'call_2': 1, 'call_3': 0, 'call_4': 0,
                'saw_f': 10, 'saw_2': 4, 'saw_3': 1, 'saw_4': 0
            }
        }
